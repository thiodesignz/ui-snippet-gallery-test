...
```bash
git remote add encore encore://ui-snippet-gallery-2q3i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ui-snippet-gallery-2q3i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ui-snippet-gallery-2q3i/settings/integrations/github)
